...
class TestSixDieClass(unittest.TestCase):
    def setUp(self):
        """
        Sets up two SixDieClass objects, a positive one with all attributes set and blank negative
        :return: SixDieClass
        """
        self.nobj = SixDieClass(False)
        self.pobj = SixDieClass(True)
    ...
    def test_get_sides(self):
        # Ensures both objects have 6 sides
        self.assertEqual(self.nobj.get_sides(), 6)
        self.assertEqual(self.pobj.get_sides(), 6)
